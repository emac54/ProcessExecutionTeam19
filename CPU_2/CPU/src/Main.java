...
public class Main {
    public static void main(String[] args) {
        // Beginnings of GUI, will be implementing correctly in final version.
        JFrame frame = new JFrame();


        String column[] = {"Process Name", "Service Time"};
        String data[][] = {{""}};
        JTable processQueueTable = new JTable(data, column);
        processQueueTable.setBounds(30,40,20,30);
        JScrollPane sp = new JScrollPane(processQueueTable);
        frame.add(sp);
